...
const Navbar = ({ theme, toggleTheme }: NavbarProps) => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 dark:bg-bg-dark/90 backdrop-blur-md py-3 shadow-lg' : 'bg-transparent py-5'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        >
          ...
          <span className={`font-black text-xl tracking-tight ${isScrolled ? 'text-gray-900 dark:text-white' : 'text-white'}`}>BREDI 3D Projetos</span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="hidden md:block bg-[linear-gradient(110deg,#BF953F,45%,#FCF6BA,55%,#B38728)] bg-[length:200%_100%] hover:bg-[100%_0] text-bg-dark font-bold px-5 py-2 rounded-lg text-sm transition-all duration-500 hover:shadow-[0_0_20px_rgba(191,149,63,0.5)] hover:brightness-110 hover:scale-105"
          >
            Orçamento
          </a>
        </div>
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-20 px-6">
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-t from-gray-50 via-gray-50/70 to-transparent dark:from-bg-dark dark:via-bg-dark/70 transition-colors duration-500 z-10" />
        <img
        ...
        />
        {/* Dark overlay for better text readability on light mode as well, slightly adjusted */}
      ...
      <div className="container mx-auto relative z-20 max-w-4xl">
        ...
        >
          <span className="inline-block bg-primary/20 text-primary border border-primary/30 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm">
            Visualização Ultra-Realista
          </span>
          {/* Force white text on Hero due to background image */}
          <h1 className="text-5xl md:text-7xl font-black leading-tight mb-6 text-white drop-shadow-md">
            Projetos 3D Profissionais para Móveis Planejados
          </h1>
          <p className="text-xl text-gray-200 mb-10 leading-relaxed max-w-2xl drop-shadow-md font-medium">
...
const BenefitCard = ({ icon: Icon, title, description }: BenefitCardProps) => (
  <div className="bg-white dark:bg-card-dark p-8 rounded-3xl border border-gray-200 dark:border-white/5 flex flex-col items-start gap-4 hover:border-primary/30 transition-all shadow-lg dark:shadow-none">
    <div className="p-4 bg-primary/10 rounded-2xl">
      <Icon className="text-primary w-8 h-8" />
    </div>
    <div>
      <h3 className="font-black text-xl mb-2 text-gray-900 dark:text-white">{title}</h3>
...
const Benefits = () => {
  ...
  return (
    <section className="py-24 px-6 bg-gray-50 dark:bg-bg-dark transition-colors duration-500">
      <div className="container mx-auto">
        <div className="mb-16">
          <h2 className="text-4xl font-black mb-4 text-gray-900 dark:text-white">Por que nos escolher?</h2>
...
const BeforeAfter = () => {
  ...
  return (
    <section className="py-24 px-6 bg-gray-100 dark:bg-bg-dark/50 transition-colors duration-500">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black mb-4 text-gray-900 dark:text-white">Visualize Antes de Produzir</h2>
          <p className="text-gray-600 dark:text-gray-400">Elimine as dúvidas do seu cliente com renderizações perfeitas.</p>
        </div>

        <div
          className="relative group rounded-[2rem] overflow-hidden aspect-[16/10] shadow-2xl border border-gray-200 dark:border-white/10 cursor-col-resize select-none"
        ...
        >
          ...
          <div className="absolute bottom-8 left-8 z-40 bg-black/60 backdrop-blur px-5 py-2 rounded-xl text-xs font-black uppercase tracking-widest border border-white/10 text-white">Técnico</div>
  ...
  return (
    <section className="py-24 px-6 bg-gray-50 dark:bg-bg-dark transition-colors duration-500">
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black mb-4 text-gray-900 dark:text-white">Investimento</h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg">Escolha o plano ideal para o seu projeto</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {/* Plan 1 */}
          <div className="bg-white dark:bg-card-dark p-10 rounded-[2.5rem] border border-gray-200 dark:border-white/5 relative overflow-hidden hover:border-gray-300 dark:hover:border-white/20 transition-all shadow-xl dark:shadow-none">
            <h3 className="text-2xl font-black mb-2 text-gray-900 dark:text-white">Apenas 3D</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-8 leading-relaxed">Ideal para apresentação ao cliente final e aprovação visual rápida.</p>
            <div className="mb-10">
              <span className="text-5xl font-black text-gray-900 dark:text-white">R$ 80,00</span>
              <span className="text-gray-500 font-bold ml-2">/ projeto</span>
            </div>
            <ul className="space-y-5 mb-10 text-gray-700 dark:text-gray-300">
          ...
          {/* Plan 2 (Featured) */}
          <div className="bg-white dark:bg-card-dark p-10 rounded-[2.5rem] border-2 border-primary relative overflow-hidden shadow-[0_0_60px_-15px_rgba(255,215,0,0.3)] scale-105 z-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-8 leading-relaxed">Solução completa para o marceneiro que quer ganhar produtividade.</p>
            <div className="mb-10">
              <span className="text-5xl font-black text-gray-900 dark:text-white">R$ 120,00</span>
              <span className="text-gray-500 font-bold ml-2">/ projeto</span>
            </div>
            <ul className="space-y-5 mb-10 text-gray-700 dark:text-gray-300">
              <li className="flex items-center gap-4 text-sm font-medium">
...
${formData.fileCount > 0 ? `📷 *TENHO ${formData.fileCount} ARQUIVO(S) PARA ENVIAR!* \n(Por favor, me indique para eu anexar as imagens aqui no chat)` : ''}`.trim();
  ...
  return (
    <section className="py-24 px-6 bg-gray-100 dark:bg-bg-dark/80 transition-colors duration-500" id="orcamento">
      <div className="container mx-auto max-w-2xl">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-black mb-3 text-gray-900 dark:text-white">Peça seu Orçamento</h2>
          <p className="text-gray-600 dark:text-gray-400">Preencha os dados e entraremos em contato em breve</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-white dark:bg-card-dark border-gray-200 dark:border-white/5 rounded-2xl focus:ring-primary focus:border-primary text-gray-900 dark:text-white p-5 outline-none transition-all"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full bg-white dark:bg-card-dark border-gray-200 dark:border-white/5 rounded-2xl focus:ring-primary focus:border-primary text-gray-900 dark:text-white p-5 outline-none appearance-none cursor-pointer"
              >
          ...
          <div className="border-t border-gray-200 dark:border-white/10 pt-8 mt-2">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                className="w-full bg-white dark:bg-card-dark border-gray-200 dark:border-white/5 rounded-2xl focus:ring-primary focus:border-primary text-gray-900 dark:text-white p-5 outline-none resize-none transition-all"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <div className={`border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all group relative ${formData.fileCount > 0 ? 'border-primary/50 bg-primary/5' : 'border-gray-300 dark:border-white/10 hover:border-primary/50 hover:bg-gray-50 dark:hover:bg-white/5'}`}>
                <input
                  type="file"
                  ...
                  accept="image/*,.pdf"
                />
                <div className="p-4 bg-gray-100 dark:bg-bg-dark rounded-full mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-black/10 dark:shadow-black/50">
...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-bg-dark border-t border-gray-200 dark:border-white/5 py-16 px-6 transition-colors duration-500">
      <div className="container mx-auto max-w-4xl flex flex-col items-center gap-10">
        <div className="flex items-center gap-2">
          <Box className="text-primary w-10 h-10" />
          <span className="font-black text-2xl tracking-tight text-gray-900 dark:text-white">BREDI 3D Projetos</span>
        </div>

        <p className="text-center text-gray-600 dark:text-gray-500 text-sm leading-relaxed max-w-sm">
          © 2024 BREDI 3D Projetos. Todos os direitos reservados.<br />
          Transformando sonhos em renders ultra-realistas.
        </p>

        {/* Developer Credit - Enhanced for visibility */}
        <a
          href="https://wa.me/5515998148402"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-bg-dark border border-white/10 rounded-full py-2.5 px-6 flex items-center gap-3 hover:scale-105 transition-transform duration-300 group shadow-lg ring-1 ring-white/5"
        >
...
const PortfolioCarousel = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-bg-dark border-t border-gray-200 dark:border-white/5 overflow-hidden transition-colors duration-500">
      <div className="container mx-auto mb-12 px-6 text-center">
        <h2 className="text-4xl font-black mb-4 text-gray-900 dark:text-white">Portfólio em Destaque</h2>
        <p className="text-gray-600 dark:text-gray-400">Confira a qualidade ultra-realista dos nossos projetos recentes</p>
      </div>

      <div className="relative w-full overflow-hidden">
        {/* Gradients adapted for both themes */}
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-white to-transparent dark:from-bg-dark dark:to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-white to-transparent dark:from-bg-dark dark:to-transparent z-10" />
        ...
        >
          {carouselImages.map((src, idx) => (
            <div
              key={idx}
              className="relative w-[400px] h-[300px] flex-shrink-0 rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10 group cursor-pointer shadow-lg dark:shadow-none"
            >
              <img
                src={src}
                alt={`Projeto ${idx + 1}`}
...
const About = () => {
  return (
    <section className="py-24 px-6 bg-gray-50 dark:bg-card-dark border-t border-gray-200 dark:border-white/5 overflow-hidden transition-colors duration-500">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight text-gray-900 dark:text-white">
              ...
              <span className="text-gray-900 dark:text-white">Realidade Visual</span>
            </h2>
            ...
            <div className="flex gap-4">
              ...
              <div className="w-px bg-gray-200 dark:bg-white/10 mx-4"></div>
              <div className="flex flex-col">
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen selection:bg-primary selection:text-bg-dark transition-colors duration-500 ${theme === 'dark' ? 'bg-bg-dark text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <main>
        ...
        {/* Testimonials */}
        <section className="py-24 px-6 bg-gray-50 dark:bg-bg-dark overflow-hidden transition-colors duration-500">
          <div className="container mx-auto">
            <h2 className="text-4xl font-black mb-16 text-center text-gray-900 dark:text-white">O que dizem nossos parceiros</h2>
            <div className="flex gap-6 overflow-x-auto hide-scrollbar snap-x snap-mandatory pb-8">
              {[
                ...
                <div key={idx} className="min-w-[85%] md:min-w-[400px] snap-center bg-white dark:bg-card-dark p-10 rounded-[2rem] border border-gray-200 dark:border-white/5 flex flex-col justify-between shadow-lg dark:shadow-none">
                  <div>
                    <div className="flex text-primary mb-6">
                      {[1, 2, 3, 4, 5].map(i => <Star key={i} className="w-5 h-5 fill-current" />)}
                    </div>
                    <p className="text-gray-600 dark:text-gray-300 italic text-lg leading-relaxed mb-8">"{t.text}"</p>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-black text-lg leading-none mb-1 text-gray-900 dark:text-white">{t.name}</p>
